...
describe('<Day2 />', () => {
  ...
  it('makes the sum === 4 * 3 = 12', () => {
    const input = 'abcdef\nbababc\nabbcde\nabcccd\naabcdd\nabcdee\nababab';
    const comp = shallow(<Day2 {...MIN_PROP_TYPES} input={input} />);
    expect(comp.find('#output').text()).toEqual([4, 3]);
  })
});
